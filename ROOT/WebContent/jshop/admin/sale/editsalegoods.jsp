...
<body>
				...
				<div class="form">
					<div class="fields">
							...
							<div class="radios">
								<div class="radio">
									<input type=radio id="salegoodsstate" name="salegoodsstate"
										class="small" value="1" /> <label>开启</label> <input
										type=radio id="salegoodsstate" name="salegoodsstate"
										class="small" checked="checked" value="0" /> <label>关闭</label>
								</div>
							</div>
						</div>
						...
						<div class="field field-first">
							...
							<div class="field field-first">
							<div class="label">
								<label for="input-small"> 参拍人数 :</label>
							</div>
							<div class="input">
	...
	<div class="field field-first">
		...
		<script type="text/javascript" src="<%=basePath%>/jshop/admin/js/addsalegoods.js"></script>
